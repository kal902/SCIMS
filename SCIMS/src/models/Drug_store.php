<?php
require_once "../SCIMS/sys/config/constants.php";
require_once "../SCIMS/sys/config/database.php";
/*
...
class DrugStore{
    ...
    public function add_drug($drug_data){
        ...
        if($this->drug_exists($drug_name)==false){ // if drug doesnt exist, insert the new data.
            ...
            $stmt .= "VALUES ('$drug_name', '$category', '$desc', '$company', '$quantity', '$date_supplied', '$manu_date', '$exp_date', '$desc_no')";
